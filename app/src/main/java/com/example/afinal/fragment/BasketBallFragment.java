...
import com.example.afinal.adapter.BasketBallAdapter;
...
public class BasketBallFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        basketBallAdapter = new BasketBallAdapter(newsModels, context);
    ...
    private void fetchDataFromApi() {
        ...
        executorService.execute(new Runnable() {
            @Override
            public void run() {
                Call<List<NewsModel>> call = apiService.getNewsNba();
                try {
