...
import com.example.afinal.DetailBasketBallActivity;
...
public class BasketBallAdapter extends RecyclerView.Adapter<BasketBallAdapter.ViewHolder> {
    ...
    public BasketBallAdapter(List<NewsModel> newsModels, Context context) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(v -> {
            Intent intent = new Intent(context, DetailBasketBallActivity.class);
